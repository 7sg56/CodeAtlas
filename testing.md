# 🧪 CodeAtlas Master Testing Suite

This document tracks the verification of **CodeAtlas v0.1** features across all target repositories. Each repository must meet the visual and functional standards established in the `ANIMAL-MERGE-GAME` baseline.

---

## 🚩 Core Bug: Framework Deduplication
**Status:** 🟠 In-Progress
**Requirement:** The "Frameworks" section must not show redundant tags (e.g., `Spring Boot (Java)`, `Spring`, and `Spring Boot` simultaneously).
